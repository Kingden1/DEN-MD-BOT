...
france({ nomCom: "developer", categorie: "General", reaction: "🚘" }, async (dest, zk, commandeOptions) => {
    ...
    const devs = [
      { nom: "DenKing", numero: "254725099642" },
      { nom: "᚛wizard᚜", numero: "254725290208" },
      // Ajoute d'autres développeurs ici avec leur nom et numéro
    ];

    let message = "Oyaah 👊\n *Welcome to DEN-Md!*\n\n*💠━━💠CREATOR INFO💠━━💠*\n\n\n *◇NAME: _Denking_*\n*◇AGE: 20*\n*◇LOCATION: _On Earth_*\n*◇BELIEVER: YES ✅*\n*◇FRIENDLY: YES ✅*\n*◇EGOISTIC: _YEEES ✅_*\n*◇FAV MOVIE: _ONE EYE_*\n*◇INSTAGRAM: https://instagram.com/denden_kibet9107?igshid=ZHp0eXhsbHU5NHV3*\n*◇Twitter: https://twitter.com/Ibrahim_adams*\n\n______________________________\n\n*🚖KEEP USING BMW-MD🚖*\n\n\n_The following are my contacts_:\n:";
...
france({ nomCom: "support", categorie: "General" }, async (dest, zk, commandeOptions) => {
  ...
  await zk.sendMessage(auteurMessage,{text : `https://wa.me/254725099642`},{quoted :ms})
